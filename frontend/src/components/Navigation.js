...
const Navigation = () => {
  ...
  const navLinks = [
    ...
    { path: '/games/active', label: '🎮 Active Games', primary: true },
    { path: '/games/completed', label: '🏆 Game History', primary: true },
    { path: '/simulation', label: '🎮 Practice Mode', primary: false },
    { path: '/signup', label: '📝 Sign Up Players', primary: false },
