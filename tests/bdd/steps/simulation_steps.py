...
def step_request_endpoint(context, method: str, endpoint: str) -> None:
    ...
    if hasattr(context, "table") and context.table:
        for row in context.table:
            ...
            set_nested_value(payload, path, parsed_value)

    result = make_simulation_request(context.client, method, endpoint, payload or None)
    ...
    context.response = _Response(result["status_code"], result["body"], result["text"])
