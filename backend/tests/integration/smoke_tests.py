...
from app.wolf_goat_pig import Player, WolfGoatPigGame
...
def test_error_handling():
    ...
    try:
        ...
        raise AssertionError("Should have raised error for invalid player")
    except:
    ...
    try:
        ...
        raise AssertionError("Should have raised error for invalid partnership")
    except:
