...
class TestFindMatches:
                ...
                "availability": [
                    {
                        "day_of_week": 0,
                        "is_available": True,
                        "available_from_time": "9:30 AM",
                        "available_to_time": "11:30 AM",
                    }
                ],
            },
        ]
    ...
    def test_find_matches_min_overlap_requirement(self):
        ...
        matches = MatchmakingService.find_matches(all_players_availability, min_overlap_hours=2.0)
...
class TestMatchQuality:
    ...
    def test_calculate_match_quality_high_duration(self):
        ...
        players = [{"available_from_time": None, "available_to_time": None} for _ in range(4)]
    ...
    def test_calculate_match_quality_morning_bonus(self):
        ...
        players = [{"available_from_time": "8:00 AM", "available_to_time": "12:00 PM"} for _ in range(4)]
