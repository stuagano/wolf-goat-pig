...
class TestShotAnalysis:
    ...
    def test_shot_quality_distribution(self):
        ...
        sa = ShotAnalysis(
            ...
            clutch_shots=[{"player": "p1", "quality": "excellent", "pressure": "high"}],
...
class TestPostHoleAnalyzer:
    ...
    def test_generate_learning_points(self, analyzer):
        ...
        decisions = [Mock(quality=DecisionQuality.POOR, decision_type="partnership")]
        ...
        points = analyzer._generate_learning_points(decisions, partnership, betting, key_moments)
    ...
    def test_generate_tips(self, analyzer):
        ...
        shots = Mock()
        shots.shot_quality_distribution = {"poor": 5, "terrible": 3, "average": 2}
    ...
    def test_full_analyze_hole(self, analyzer, mock_hole_state):
        ...
        analytics = analyzer.analyze_hole(mock_hole_state, game_state, events)
