...
DEFAULT_COURSES = {
    "Wing Point": [
        {"hole_number": 1, "stroke_index": 5, "par": 4, "yards": 420, "description": "Dogleg right with water hazard on the right side. Requires accurate tee shot to avoid trouble."},
        {"hole_number": 2, "stroke_index": 13, "par": 4, "yards": 385, "description": "Straightaway par 4 with slight uphill approach. Fairway bunkers guard the landing area."},
        {"hole_number": 3, "stroke_index": 1, "par": 5, "yards": 580, "description": "Long par 5 with fairway bunkers and water hazard. Three-shot hole for most players."},
        {"hole_number": 4, "stroke_index": 17, "par": 3, "yards": 165, "description": "Short par 3 over water to an elevated green. Wind can be a significant factor."},
        {"hole_number": 5, "stroke_index": 7, "par": 4, "yards": 445, "description": "Long par 4 with out of bounds left. Demanding tee shot and approach."},
        {"hole_number": 6, "stroke_index": 11, "par": 4, "yards": 395, "description": "Slight dogleg left with trees lining both sides. Position off the tee is key."},
        {"hole_number": 7, "stroke_index": 15, "par": 5, "yards": 520, "description": "Reachable par 5 in two for long hitters. Risk/reward second shot over water."},
        {"hole_number": 8, "stroke_index": 3, "par": 3, "yards": 185, "description": "Long par 3 with deep bunkers protecting the green. Club selection is crucial."},
        {"hole_number": 9, "stroke_index": 9, "par": 4, "yards": 410, "description": "Finishing hole with elevated green. Approach shot requires extra club."},
        {"hole_number": 10, "stroke_index": 2, "par": 4, "yards": 455, "description": "Championship tee makes this a very challenging par 4. Narrow landing area."},
        {"hole_number": 11, "stroke_index": 16, "par": 5, "yards": 545, "description": "Three-shot par 5 with creek crossing the fairway. Strategic layup required."},
        {"hole_number": 12, "stroke_index": 8, "par": 3, "yards": 175, "description": "Elevated tee with wind factor. Green slopes from back to front."},
        {"hole_number": 13, "stroke_index": 14, "par": 4, "yards": 375, "description": "Short par 4, drivable green for long hitters. Bunkers protect the green."},
        {"hole_number": 14, "stroke_index": 4, "par": 4, "yards": 435, "description": "Narrow fairway with difficult approach shot. Trees and bunkers create challenge."},
        {"hole_number": 15, "stroke_index": 18, "par": 5, "yards": 565, "description": "Longest hole on course. Generous fairway but long approach to elevated green."},
        {"hole_number": 16, "stroke_index": 10, "par": 4, "yards": 425, "description": "Risk/reward hole with water hazard. Aggressive play can pay off."},
        {"hole_number": 17, "stroke_index": 12, "par": 3, "yards": 155, "description": "Island green signature hole. Short but intimidating with water all around."},
        {"hole_number": 18, "stroke_index": 6, "par": 4, "yards": 415, "description": "Dramatic finishing hole with water hazard and elevated green. Classic risk/reward."},
    ],
    "Championship Links": [
