...
class GameStateValidator:
    ...
    def validate_player_count(player_count: int) -> None:
        ...
        Wolf-Goat-Pig is designed for 4-6 players for optimal partnership dynamics.
        This strict validation matches the game initialization requirements.

        Args:
            player_count: Number of players

        Raises:
            GameStateValidationError: If player count is not 4, 5, or 6

        Example:
            >>> GameStateValidator.validate_player_count(4)  # OK
            >>> GameStateValidator.validate_player_count(5)  # OK
            >>> GameStateValidator.validate_player_count(6)  # OK
            >>> GameStateValidator.validate_player_count(3)  # Raises error
        """
