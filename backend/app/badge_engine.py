...
class BadgeEngine:
    ...
    def check_post_game_achievements(self, game_record_id: int, player_profile_id: int) -> list[PlayerBadgeEarned]:
        ...
        player_stats = self.db.query(PlayerStatistics).filter_by(player_id=player_profile_id).first()
    ...
    def _check_perfect_partnership_rate(
        self,
        player_id: int,
        stats: PlayerStatistics,
        result: GamePlayerResult,
    ...
    def _check_partnership_streak_20(
        self,
        player_id: int,
        stats: PlayerStatistics,
        result: GamePlayerResult,
    ...
    def _check_games_played_milestone(
        self,
        player_id: int,
        stats: PlayerStatistics,
        result: GamePlayerResult,
    ...
    def _check_holes_won_milestone(
        self,
        player_id: int,
        stats: PlayerStatistics,
        result: GamePlayerResult,
    ...
    def _check_four_horsemen_famine(
        self,
        player_id: int,
        stats: PlayerStatistics,
        result: GamePlayerResult,
    ...
    def _check_four_horsemen_pestilence(
        self,
        player_id: int,
        stats: PlayerStatistics,
        result: GamePlayerResult,
        ...
        recent_games = (
            ...
            .order_by(GamePlayerResult.created_at.desc())
            .limit(5)
            .all()
        )
    ...
    def _check_four_horsemen_death(
        self,
        player_id: int,
        stats: PlayerStatistics,
        result: GamePlayerResult,
    ...
    def _update_progression_badges(self, player_profile_id: int, stats: PlayerStatistics) -> None:
        ...
        progression_badges = (
            self.db.query(Badge).filter(and_(Badge.trigger_type == "career_milestone", Badge.is_active == True)).all()
        )
    ...
    def _check_series_completion(self, player_profile_id: int, newly_earned_badge: Badge) -> None:
        ...
        series_progress = (
            self.db.query(PlayerSeriesProgress)
            .filter(
                and_(
