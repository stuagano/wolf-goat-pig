"""Hole setup for WolfGoatPigGame — initialization, hitting order, base wagers, phases."""
...
class HoleSetupMixin:
    """Per-hole initialization: hitting order rotation, base wager, phase transitions."""
